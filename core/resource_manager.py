"""
Resource Manager - مراقبة والتحكم في الموارد الحاسوبية
Monitors CPU, Memory and controls concurrent operations
"""
...
class ResourceMonitor:
    ...
    def get_average_metrics(self, seconds: int = 30) -> Optional[ResourceMetrics]:
        """الحصول على متوسط القياسات للفترة المحددة"""
        with self.lock:
