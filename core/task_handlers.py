...
def handle_send_notification(user_id: int, message: str):
    """محاكاة إرسال إشعار للمستخدم (الوقت الحقيقي: 2 ثانية)"""
...
def handle_generate_invoice(order_id: int):
    """محاكاة إصدار فاتورة للطلب (الوقت الحقيقي: 3 ثوان)"""
...
def handle_order_confirmation(order_id: int):
    """محاكاة إرسال تأكيد الطلب (الوقت الحقيقي: 1.5 ثانية)"""
...
def handle_payment_receipt(order_id: int):
    """محاكاة إرسال إيصال الدفع (الوقت الحقيقي: 2.5 ثانية)"""
